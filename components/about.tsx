...
const stats = [
  { value: "15+", label: "años en el mercado", icon: Award, accent: true },
  ...
  { value: "100%", label: "Garantía de calidad", icon: Shield, accent: false },
]

export function About() {
  return (
    <section id="nosotros" className="py-20 md:py-28 overflow-hidden" style={{ background: "rgba(255,255,255,0.8)", backdropFilter: "blur(3px)" }}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-5 text-muted-foreground leading-relaxed text-base">
            <p>
              ...
              <strong className="text-foreground font-bold">15 años en el mercado</strong>, dedicada a
              distribuir una gran variedad de canastillas, estibas plásticas y otros
              productos que facilitan el desarrollo de las diferentes actividades económicas.
            </p>
            <p>
              ...
              la región, con productos que cumplen los más altos estándares de durabilidad.
            </p>
            <p>
          ...
          <div className="bg-muted/40 rounded-3xl p-8 border border-border space-y-4">
            <h3 className="text-xl font-black text-foreground">¿Por qué elegirnos?</h3>
            <ul className="space-y-3">
              {[
                "15 años de trayectoria y experiencia",
